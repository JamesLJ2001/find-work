...
当前临时覆盖：2026 年 9 月 4—6 日按计划文件“9 月 4 日至 6 日均衡收官”执行，新题基线 7/6/6、每天复习 29 项。规则 6 的“每天追加全部红题”在这三天改为按额外组分摊；D 队列、永久退役和真实作答要求不变。未来日预案只能在当晚结合实际记录重算后成为唯一执行单，不能把计划题当作已作答。9 月 6 日后恢复下面的常规规则。
