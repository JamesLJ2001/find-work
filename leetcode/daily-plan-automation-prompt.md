...
当前临时覆盖：用户于 2026 年 9 月 8 日明确要求“昨天题做了复习没复习也无所谓了，今天继续来计划，新题先保证”，执行计划文件“9 月 8 日继续第二天，新题优先（最新显式覆盖）”。9 月 7 日实际完成 7 道新题的学习记录、没有复习记录，截止来源行 227。9 月 8 日优先完成原第 2 天的 6 道新题：72、14、43、166、125、151；D+1/D+3/D+7 来源分别为 9 月 7 日、8 月 27 日、8 月 23 日，分别为 7、4、0 题，原第 2 组额外复测 18 题。四个复习队列共 29 题均为选做，不补昨天未复习的整批任务，不妨碍当天新题目标或下一学习日安排。本轮后续继续新题优先、复习选做，直到用户调整要求；设置 `reviewsOptional: true`，主进度仅计算新题，复习单独计数。规则 6 的“每天追加全部红题”继续改为按额外组分摊；D 来源重算、永久退役和真实作答要求不变。第 3 批仅保留预案，下次明确排程时再按实际记录落实日期，不能把计划题当作已作答。
