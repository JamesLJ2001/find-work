...
当前临时覆盖：2026 年 9 月 4 日暂停且无作答记录，不计有效学习日；按用户“明天开始刷”的要求，三日计划整体顺延到 9 月 5—7 日，执行计划文件“9 月 5 日至 7 日均衡收官”，新题基线 7/6/6、每天复习 29 项。规则 6 的“每天追加全部红题”在这三天改为按额外组分摊；D 队列、永久退役和真实作答要求不变。9 月 5 日的 D+1/D+3/D+7 来源仍为 9 月 3 日、8 月 26 日、8 月 19 日。未来日预案只能在当晚结合实际记录重算后成为唯一执行单，不能把计划题当作已作答。9 月 7 日后恢复下面的常规规则。
